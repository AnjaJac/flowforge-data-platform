...
def test_clean_orders_preserves_row_count():
    df = pl.DataFrame({
        ...
        "order_delivered_carrier_date": ["2024-01-02 09:00:00", "2024-02-02 09:00:00"],
        "order_delivered_customer_date": ["2024-01-05 14:00:00", "2024-02-05 14:00:00"],
        "order_estimated_delivery_date": ["2024-01-10 00:00:00", "2024-02-10 00:00:00"],
    })
    result = clean_orders(df)
